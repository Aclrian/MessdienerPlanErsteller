...
public class PfarreiController {
    ...
    public void save(ActionEvent e) {
        ...
        if (nameS != null) WriteFilePfarrei.writeFile(pf);
    ...
    public void weiter(ActionEvent e) {
        weiter();
        try {
            Dialogs.open(URI.create("https://github.com/Aclrian/MessdienerPlanErsteller/wiki/Was-wird-unter-'Anzahl'-verstanden%3F"),
