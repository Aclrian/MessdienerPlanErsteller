...
import net.aclrian.messdiener.messdiener.ReadFile;
import net.aclrian.messdiener.pfarrei.Pfarrei;
import net.aclrian.messdiener.pfarrei.ReadFile_Pfarrei;
...
public class DateienVerwalter {
    ...
    /**
     * Öffnet den DateiAuswaehler an einem Ort mit dem angegebenen Pfad und gibt
	...
	try {
	    ...
	    Utilities.logging(this.getClass(), "getMessdienerFile",
		    "Die Eingabe wurde vom Benutzer beendet!");
	}
	...
	Utilities.logging(this.getClass(), "getSpeicherort",
		"Das Home-Verzeichniss wurde gefunden: " + homedir);
	...
	if (!f.exists()) {
		...
		while ((line = bufferedReader.readLine()) != null) {
			...
			Utilities.logging(this.getClass(), "getSpeicheort",
