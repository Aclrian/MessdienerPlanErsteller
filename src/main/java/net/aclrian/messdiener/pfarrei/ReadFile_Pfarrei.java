							...
							if (ne.getNodeType() == 1) {
								...
								if (eE.hasAttribute("year")) {
									...
									if (i < Einstellungen.lenght && i > -1) {
										...
										Utilities.logging(ReadFile_Pfarrei.class, "getPfarrei" ,"id ist zu gro"+References.ss+"!");
									...
									Utilities.logging(ReadFile_Pfarrei.class, "getPfarrei","unbekannte Node:"+ eE.getTagName());
								}
							}
						}
					}
