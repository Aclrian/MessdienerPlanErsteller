...
public class AbmeldenPane extends APanel {
    ...
    public AbmeldenPane(int defaultButtonwidth, int defaultButtonheight, AProgress ap) {
	...
	scrollpane.setBounds(abstandweit, abstandhoch, width-2*abstandweit, heigth-4*abstandhoch-this.getDfbtnheight());
	...
	label.setBounds(2*abstandweit+this.getDfbtnwidth(),  heigth-3*abstandhoch-this.getDfbtnheight(), drei, stdhoehe);
	einteilen.setBounds(2*abstandweit+this.getDfbtnwidth(), heigth-3*abstandhoch-this.getDfbtnheight()+stdhoehe, drei, stdhoehe);
	austeilen.setBounds(2*abstandweit+this.getDfbtnwidth()+drei, heigth-3*abstandhoch-this.getDfbtnheight()+stdhoehe, drei, stdhoehe);
    }
