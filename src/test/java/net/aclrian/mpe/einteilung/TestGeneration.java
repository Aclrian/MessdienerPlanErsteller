...
class TestGeneration {
    ...
    void generiereDefaultMessen() {
        ...
        var list = Einteilung.generiereDefaultMesseFuerStandardmesse(sm, startDate, endDate);
        ...
        list = Einteilung.generiereDefaultMesseFuerStandardmesse(sm, startDate, endDate);
        assertThat(list).hasSize(1);
        ...
        var listDuplicate = Einteilung.generiereDefaultMesseFuerStandardmesse(sm, startDate, endDate);
        assertThat(list).hasSize(1);
